"""Support for Hyperion classic remotes."""
import json
import logging
import socket
...
SUPPORT_HYPERION_CLASSIC = SUPPORT_COLOR | SUPPORT_BRIGHTNESS | SUPPORT_EFFECT
...
def setup_platform(hass, config, add_entities, discovery_info=None):
    """Set up a Hyperion classic server remote."""
...
class Hyperion_classic(LightEntity):
    """Representation of a Hyperion classic remote."""
    ...
    def supported_features(self):
        ...
        return SUPPORT_HYPERION_CLASSIC
    ...
    def update(self):
        ...
        if response:
            # workaround for outdated Hyperion classic
            if "activeLedColor" not in response["info"]:
                ...
                self._effect = None
                return
            # Check if Hyperion classic is in ambilight mode trough an HDMI grabber
            try:
